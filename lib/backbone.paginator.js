  ...
  var PageableCollection = Backbone.PageableCollection = Backbone.Collection.extend({
    ...
    */
    constructor: function (models, options) {
      ...
      this.additionalData = _extend({}, options.additionalData);
    },
    ...
    */
    _checkState: function (state) {
      ...
      if (totalRecords != null && pageSize !== null && pageSize !== false && currentPage != null &&
        ...
        //obviously set it to null to proper work backgrid-paginator
        state.lastPage = null;
        state.totalPages = null;
      }
    ...
    */
    parse: function (resp, options) {
      ...
      if (resp && !_isUndefined(resp[2])) {
        this.additionalData = resp[2];
      }
     ...
     */
    parseState: function (resp, queryParams, state, options) {
      if (resp && _isObject(resp[0]) && _isArray(resp[1])) {
    ...
    */
    ...
    stateToJSON : function() {
      var out = {};
      _each(this.state, function(val, key) {
        if (val !== null && !_isEmpty(this.queryParams[key])) {
          if (key == 'order') {
            val = this.queryParams.directions[val];
          }

          out[this.queryParams[key]] = val;
        }
      }, this);
    ...
    toJSONAll : function(options) {
      return [
        this.stateToJSON(),
        Backbone.Collection.prototype.toJSON.apply(this, arguments),
        _clone(this.additionalData)
      ];
    },

    resetByArr : function(inputArr) {
      this.reset(this.parse(inputArr));
    }
  }, {
    createByArray : function(inputArr) {
      var collection = new this();
      collection.resetByArr(inputArr);
